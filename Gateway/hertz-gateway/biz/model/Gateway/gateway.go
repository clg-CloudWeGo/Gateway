...
type IdlService interface {
	...
	UpdateService(ctx context.Context, service *ServiceInfo) (r *SuccessResp, err error)

	GetService(ctx context.Context, serviceReq *ServiceReq) (r *ServiceInfo, err error)

	ListService(ctx context.Context) (r []*ServiceInfo, err error)
}
...
func (p *IdlServiceClient) UpdateService(ctx context.Context, service *ServiceInfo) (r *SuccessResp, err error) {
...
func (p *IdlServiceClient) GetService(ctx context.Context, serviceReq *ServiceReq) (r *ServiceInfo, err error) {
...
func (p *IdlServiceClient) ListService(ctx context.Context) (r []*ServiceInfo, err error) {
...
var IdlServiceUpdateServiceArgs_Service_DEFAULT *ServiceInfo

func (p *IdlServiceUpdateServiceArgs) GetService() (v *ServiceInfo) {
	if !p.IsSetService() {
...
type IdlServiceGetServiceResult struct {
	Success *ServiceInfo `thrift:"success,0,optional"`
}
...
var IdlServiceGetServiceResult_Success_DEFAULT *ServiceInfo

func (p *IdlServiceGetServiceResult) GetSuccess() (v *ServiceInfo) {
	if !p.IsSetSuccess() {
...
var IdlServiceListServiceResult_Success_DEFAULT []*ServiceInfo

func (p *IdlServiceListServiceResult) GetSuccess() (v []*ServiceInfo) {
	if !p.IsSetSuccess() {
...
func (p *IdlServiceListServiceResult) ReadField0(iprot thrift.TProtocol) error {
	...
	p.Success = make([]*ServiceInfo, 0, size)
	for i := 0; i < size; i++ {
		_elem := NewServiceInfo()
